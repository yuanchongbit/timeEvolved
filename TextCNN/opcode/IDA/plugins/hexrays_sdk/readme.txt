...
---------
  ...
  In other words we fix a goto target is it points to a chain of gotos.
...
Please note that microcode is not exposed in Python.
...
Microcode is represented by the mbl_array_t class. This object contains
...
call one of the following functions after modifying microcode or ctree:
  ...
  - mbl_array_t::verify(bool always);
