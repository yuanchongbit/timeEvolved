...
class idaapi_Cvar(object):
    def __init__(self):
        ...
        object.__setattr__(self, "modules", "hexrays,allins,auto,bytes,dbg,diskio,entry,enum,expr,fixup,fpro,frame,funcs,gdl,graph,ida,idaapi,idc,idd,idp,kernwin,lines,loader,moves,nalt,name,netnode,offset,pro,problems,range,registry,search,segment,segregs,strlist,struct,tryblks,typeinf,ua,xref".split(","))
