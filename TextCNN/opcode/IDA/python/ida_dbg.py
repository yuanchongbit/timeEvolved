...
class tev_reg_values_t(object):
    ...
    def __init__(self, *args):
        ...
        """
        this = _ida_dbg.new_tev_reg_values_t(*args)
        try: self.this.append(this)
        except: self.this = this
...
tev_reg_values_t_swigregister = _ida_dbg.tev_reg_values_t_swigregister
tev_reg_values_t_swigregister(tev_reg_values_t)
...
class tevinforeg_vec_t(object):
    ...
    def __init__(self, *args):
        ...
        """
        this = _ida_dbg.new_tevinforeg_vec_t(*args)
        try: self.this.append(this)
        except: self.this = this
...
tevinforeg_vec_t_swigregister = _ida_dbg.tevinforeg_vec_t_swigregister
tevinforeg_vec_t_swigregister(tevinforeg_vec_t)
...
class bpt_t(object):
    ...
    pid = _swig_property(_ida_dbg.bpt_t_pid_get, _ida_dbg.bpt_t_pid_set)
    tid = _swig_property(_ida_dbg.bpt_t_tid_get, _ida_dbg.bpt_t_tid_set)
...
class tev_reg_value_t(object):
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    value = _swig_property(_ida_dbg.tev_reg_value_t_value_get, _ida_dbg.tev_reg_value_t_value_set)
    reg_idx = _swig_property(_ida_dbg.tev_reg_value_t_reg_idx_get, _ida_dbg.tev_reg_value_t_reg_idx_set)
    def __init__(self, *args):
        """
        __init__(self, _reg_idx=-1, _value=uint64(-1)) -> tev_reg_value_t
        """
        this = _ida_dbg.new_tev_reg_value_t(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _ida_dbg.delete_tev_reg_value_t
    __del__ = lambda self : None;
tev_reg_value_t_swigregister = _ida_dbg.tev_reg_value_t_swigregister
tev_reg_value_t_swigregister(tev_reg_value_t)
...
class tev_info_reg_t(object):
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    info = _swig_property(_ida_dbg.tev_info_reg_t_info_get, _ida_dbg.tev_info_reg_t_info_set)
    registers = _swig_property(_ida_dbg.tev_info_reg_t_registers_get, _ida_dbg.tev_info_reg_t_registers_set)
    def __init__(self, *args):
        """
        __init__(self) -> tev_info_reg_t
        """
        this = _ida_dbg.new_tev_info_reg_t(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _ida_dbg.delete_tev_info_reg_t
    __del__ = lambda self : None;
tev_info_reg_t_swigregister = _ida_dbg.tev_info_reg_t_swigregister
tev_info_reg_t_swigregister(tev_info_reg_t)
