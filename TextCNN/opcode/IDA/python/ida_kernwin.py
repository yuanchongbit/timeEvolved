...
jobj_wrapper_t_swigregister = _ida_kernwin.jobj_wrapper_t_swigregister
jobj_wrapper_t_swigregister(jobj_wrapper_t)
...
class chooser_item_attrs_t(object):
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    flags = _swig_property(_ida_kernwin.chooser_item_attrs_t_flags_get, _ida_kernwin.chooser_item_attrs_t_flags_set)
    color = _swig_property(_ida_kernwin.chooser_item_attrs_t_color_get, _ida_kernwin.chooser_item_attrs_t_color_set)
    def __init__(self, *args):
        """
        __init__(self) -> chooser_item_attrs_t
        """
        this = _ida_kernwin.new_chooser_item_attrs_t(*args)
        try: self.this.append(this)
        except: self.this = this
    def reset(self, *args):
        """
    ...
    __del__ = lambda self : None;
chooser_item_attrs_t_swigregister = _ida_kernwin.chooser_item_attrs_t_swigregister
chooser_item_attrs_t_swigregister(chooser_item_attrs_t)
...
class action_ctx_base_t(object):
    ...
    regname = _swig_property(_ida_kernwin.action_ctx_base_t_regname_get, _ida_kernwin.action_ctx_base_t_regname_set)
...
def _choose_get_embedded_chobj_pointer(*args):
  """
  _choose_get_embedded_chobj_pointer(self) -> uint64
  """
